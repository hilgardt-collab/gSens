...
SOURCE_METADATA = sorted([
    ...
    {'key': 'combo', 'class_name': 'ComboDataSource', 'name': 'Combo', "displayers": ["combo"], "default_size": (6, 6)},
    {'key': 'level_bar_combo', 'class_name': 'LevelBarComboDataSource', 'name': 'Combo (Level Bars)', "displayers": ["level_bar_combo"], "default_size": (6, 4)},
    ...
    {'key': 'disk_usage', 'class_name': 'DiskUsageDataSource', 'name': 'Disk Usage', "displayers": ["bar", "arc_gauge", "indicator", "level_bar", "speedometer"], "default_size": (3, 3)},
...
DISPLAYER_METADATA = sorted([
    ...
    {'key': 'combo', 'class_name': 'ComboDisplayer', 'name': 'Combo (Arcs)'},
