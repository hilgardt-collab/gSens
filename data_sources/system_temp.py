...
class SystemTempDataSource(DataSource):
    ...
    def get_config_model():
        ...
        model["Graph Range"] = [ConfigOption("graph_min_value", "scale", "Graph Min Temp (°C):", "0.0", -50.0, 200.0, 1.0, 1),
                                ConfigOption("graph_max_value", "scale", "Graph Max Temp (°C):", "100.0", -50.0, 200.0, 1.0, 1)]
        return model
