...
class FanSpeedDataSource(DataSource):
    ...
    def get_config_model():
        ...
        model["Graph Range"] = [ConfigOption("graph_min_value", "scale", "Graph Min RPM:", "0.0", 0.0, 5000.0, 10.0, 0), ConfigOption("graph_max_value", "scale", "Graph Max RPM:", "3000.0", 100.0, 10000.0, 100.0, 0)]
        return model
    ...
    def get_configure_callback(self):
        def setup_auto_title_logic(dialog, content_box, widgets, available_sources, panel_config):
            try:
                fan_combo, title_entry = widgets["selected_fan_key"], widgets["title_text"]
            except KeyError:
                return
