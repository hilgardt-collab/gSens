...
def get_config_from_widgets(widgets, models_list):
    ...
    # --- BUG FIX ---
    # Create a single, flat dictionary of all possible option definitions from all models
    # to handle arbitrarily nested model structures from dynamic UI generation.
    all_option_defs = {}
